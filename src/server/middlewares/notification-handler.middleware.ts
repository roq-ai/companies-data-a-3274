...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  ...
  'credit_limit.update': {
    ...
    tenantPath: ['organization', 'user', 'credit_limit'],
    userPath: [],
  },
  'data_filter.create': {
    roles: ['data-analyst'],
    key: 'new-filter-created',
    tenantPath: ['organization', 'user', 'data_filter'],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['system-administrator', 'data-analyst'];
