...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Companies Data App`}</title>

        <meta
          name="description"
          content="Unlock the power of B2B prospecting with Companies Data App. Experience advanced filtering, informative graphics, detailed profiles, and seamless data export in one powerful system."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1543269865-cbf427effbad?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxCMkJ8ZW58MHx8fHwxNjk0OTc5NTkxfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Unlock the power of B2B prospecting with Companies Data App. Experience advanced filtering, informative graphics, detailed profiles, and seamless data export in one powerful system.`}
            </Text>
            <Box
