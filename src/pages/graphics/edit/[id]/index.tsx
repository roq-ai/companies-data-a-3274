...
import { getGraphicById, updateGraphicById } from 'apiSdk/graphics';
...
function GraphicEditPage() {
  ...
  const handleSubmit = async (values: GraphicInterface, { resetForm }: FormikHelpers<any>) => {
    setFormError(null);
    try {
      const updated = await updateGraphicById(id, values);
      mutate(updated);
      resetForm();
